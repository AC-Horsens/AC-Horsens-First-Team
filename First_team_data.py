...
def League_stats():
    ...
    matchstats_df['PPDA per match'] = matchstats_df['PPDA'] / matchstats_df['matches']
    matchstats_df['Total Space control %'] = matchstats_df['Total Control Area %'] / matchstats_df['matches']
    matchstats_df['Center Space control %'] = matchstats_df['Center Control Area %'] / matchstats_df['matches']
    matchstats_df['Penalty Area Space control %'] = matchstats_df['Penalty Area Control %'] / matchstats_df['matches']
