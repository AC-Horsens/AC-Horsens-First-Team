...
def Process_data_spillere(df_possession_xa,df_pv_all,df_matchstats,df_xg_all,squads):
    ...
    def number10():
        ...
        df_10['Chance creation'] = df_10[['attAssistOpenplay_per90 score','penAreaEntries_per90 score','Forward zone pass % score','finalThird passes % score','Possession value total score','Possession value score','dribble % score','touches_in_box_per90 score','totalThroughBall_per90 score','xA_per90 score']].mean(axis=1)
